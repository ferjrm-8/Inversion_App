  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-slate-950/80 backdrop-blur-xl shadow-lg shadow-black/30">
      <div className="mx-auto max-w-7xl px-2.5 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:h-16 sm:items-center sm:justify-between py-2 sm:py-0 gap-2 sm:gap-4">
          
          {/* Row 1 on Mobile / Left Side on Desktop: Logo & Title + Cloud Status on Mobile */}
          <div className="flex items-center justify-between sm:justify-start gap-2 sm:gap-2.5 min-w-0 w-full sm:w-auto">
            {/* Logo & App Title */}
            <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
              <div className="flex h-8 w-8 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-tr from-purple-600 via-purple-500 to-indigo-600 shadow-lg shadow-purple-600/30 text-white">
            ...
            {/* Cloud Auth & Status Button (Visible on Row 1 for Mobile) */}
            <div className="sm:hidden shrink-0">
              {!account ? (
                <button
                  id="login-btn-top-mobile"
                  onClick={onOpenAuth}
                  className="flex items-center gap-1.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white px-2.5 py-1 text-xs font-semibold shadow-md shadow-purple-600/25 transition cursor-pointer"
                  title="Sincronizar datos en la nube"
                >
                ...
                <div className="relative">
                  <button
                    ...
                    className={`flex items-center gap-1.5 rounded-xl border px-2.5 py-1 text-xs font-semibold shadow-md transition cursor-pointer backdrop-blur-md ${
                      syncStatus === 'syncing'
          ...
          <div className="flex items-center justify-between sm:justify-end gap-1.5 sm:gap-2 w-full sm:w-auto pt-1 sm:pt-0 border-t sm:border-t-0 border-white/10">
            {/* Tab Navigation (Registro vs Métricas) */}
            <div className="flex items-center rounded-xl bg-slate-900/90 p-1 border border-slate-700/60 shadow-inner shrink-0">
              <button
            ...
            {/* Right Action Controls: Desktop Cloud Status + Backup + Borrar Todo */}
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              {/* Desktop Cloud Auth & Status Button */}
              <div className="hidden sm:block">
                {!account ? (
                  <button
                    id="login-btn-top-desktop"
                    onClick={onOpenAuth}
                    className="flex items-center gap-1.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white px-3.5 py-1.5 text-xs font-semibold shadow-md shadow-purple-600/25 transition cursor-pointer"
                  ...
                  <div className="relative">
                    <button
                      ...
                      onClick={() => setShowUserMenu(!showUserMenu)}
                      className={`flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-xs font-semibold shadow-md transition cursor-pointer backdrop-blur-md ${
                        syncStatus === 'syncing'
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-rose-900/80 bg-rose-950/60 hover:bg-rose-900/90 text-rose-300 hover:text-white px-2 sm:px-2.5 py-1.5 text-xs font-semibold shadow-md transition cursor-pointer backdrop-blur-md"
